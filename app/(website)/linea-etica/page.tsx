        ...
        <Wrapper>
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-3 gap-5">
              <div
                style={{
                  backgroundImage: `url('/promotec.portal/images/promotec2.jpg')`
                }}
                className="rounded-[30px] bg-princ-blue bg-center bg-cover"
              ></div>
          ...
          <div className="w-11/12 mx-auto space-y-8">
            <div className="space-y-16">
              ...
              <div className="grid grid-cols-2 auto-rows-[208px] gap-4">
                <div className="col-span-2 px-10 rounded-[20px] bg-white flex items-center gap-8">
                ...
                <div className="px-10 rounded-[20px] bg-white flex items-center gap-8">
