...
const coverages = [
    {
        ...
        img: getAssetPath("/images/products/travel/coverages/1.jpg")
    },
    {
        title: "**Cobertura en todo el mundo:** Viaja tranquilo a tus destinos internacionales con las mejores coberturas.",
        img: getAssetPath("/images/products/travel/coverages/2.jpg")
    },
    {
        ...
        img: getAssetPath("/images/products/travel/coverages/3.jpg")
    },
]
                ...
                <Wrapper>
                    <div className="flex flex-col lg:flex-row items-center gap-10">
                        <Image
                            ...
                            src={getAssetPath("/images/products/travel/p.png")}
                            alt=""
                            width={576}
                            height={576}
                         />
