...
const faqs = [
  ...
  },
  {
    ...
    answer: "Comunícate al numeral de tu Aseguradora.  Para resolver cualquier duda, solicitud o inquietud, comunícate con nosotros a nuestra área de siniestros al (601) 7423700 opción 1-6-1 o al correo electrónico: analista.indemnizaciones@promotec.com.co"
  },
  {
    question: "¿Qué valor agregado me ofrece Promotec?",
    answer: "Te permite comparar entre diversas aseguradoras y encontrar la póliza ideal para ti. Te brindamos asesoría personalizada en todo el proceso de compra."
  },
];
      ...
      <div className="h-[448px] relative bg-blue-terciary">
        ...
        <Wrapper>
          ...
          <h1 className="h-56 absolute top-1/2 -translate-y-1/2 flex flex-col justify-center leading-none text-4xl md:text-[50px] text-blue-terciary">
            <RichText text="Tranquilidad asegurada **para arrendadores y arrendatarios**" />
          </h1>
        </Wrapper>
      </div>
      ...
      <section className="py-[80px] bg-gray-3">
        <Wrapper>
          <div className="space-y-10">
            ...
            <div className="grid auto-cols-[464px] justify-center gap-6">
              {plans.map((p, i) => (
                <PlanCard
                  key={i}
                  title={p.title}
