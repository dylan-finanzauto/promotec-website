...
const About: React.FC = () => {
  ...
  return (
    <>
      <Banner titleTop="¿Quiénes" titleBottom="somos?" />
        ...
        <Wrapper>
          <div className="space-y-5">
            <div className="fade-up grid grid-cols-3 gap-5">
              ...
              <div
                className="rounded-[30px] bg-princ-blue bg-[url('/Promotec.Website.Client/images/promotec.jpg')] bg-center bg-cover"
              ></div>
            </div>
            <div className="fade-up grid grid-cols-3 gap-5">
              <div
                className="rounded-[30px] bg-princ-blue bg-[url('/Promotec.Website.Client/images/promotec2.jpg')] bg-center bg-cover"
              ></div>
              <div className="col-span-2 py-20 px-28 rounded-[30px] bg-text2 space-y-10">
        ...
        <Wrapper>
          <div className="flex items-center gap-10">
            <div className="relative">
              <div className="fade-left size-[576px] bg-[url('/Promotec.Website.Client/images/promotec9.jpg')] bg-cover bg-center mask-[url('/Promotec.Website.Client/icons/p.svg')] mask-no-repeat mask-center mask-size-contain">
              </div>
